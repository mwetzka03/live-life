export const de = {
  ...
  help: {
    ...
    visionboard:
      'Bucketlist links und dein persönliches Visionboard rechts – mit Bildern, Texten und Formen.',
  ...
  challenges: {
    ...
    groups: {
      add: 'Gruppe',
      newTitle: 'Neue Gruppen-Challenge',
      editTitle: 'Gruppen-Challenge bearbeiten',
      oneTime: 'Gruppe · einmalig',
      progress: '{{done}}/{{total}} erledigt',
      linkedChallenges: 'Einzel-Challenges',
      noLinked: 'Noch keine Challenges verknüpft.',
  ...
  shop: {
    ...
    sectionRegular: 'Shop-Artikel',
    sectionBucketlist: 'Aus der Bucketlist',
    fromBucketlist: 'Visionboard',
  ...
  bucketlist: {
    ...
    modal: {
      ...
      year: 'Jahr',
      addToShop: 'Als Shopeintrag anbieten',
    },
    inShop: 'Im Shop',
  },
  ...
  visionboard: {
    title: 'Visionboard',
    subtitle: 'Träume links – dein Visionboard rechts',
    defaultText: 'Dein Ziel',
    selectBoard: 'Visionboard wählen',
    ...
    inspector: {
      ...
      crop: 'Zuschneiden',
      cropReset: 'Zuschnitt zurücksetzen',
      format: 'Formatierung',
      bold: 'Fett',
      italic: 'Kursiv',
  ...
  settings: {
    ...
    data: {
      ...
      desc: 'Exportiere alle lokalen Daten inkl. CalDAV- und Apple-Reminders-Verknüpfungen, importiere ein Backup oder lösche Daten.',
      export: 'Exportieren',
      import: 'Importieren',
      clearData: 'Alle Daten löschen',
      resetApp: 'App zurücksetzen',
      exportDone: 'Backup wurde heruntergeladen.',
      importFailed: 'Import fehlgeschlagen – ungültige Datei.',
      confirmClearTitle: 'Alle Daten löschen?',
      confirmClearBody:
        'Challenges, Kalender-Einträge (lokal), Münzen, Shop, Visionboards und Bucketlist werden gelöscht. CalDAV- und Apple-Reminders-Konten bleiben erhalten.',
      confirmResetTitle: 'App zurücksetzen?',
      confirmResetBody:
        'Alle lokalen Daten und Einstellungen werden gelöscht – inklusive Sync-Konten. Die App startet wie beim ersten Mal neu.',
    },
  },

  onboarding: {
    title: 'Willkommen bei Live Life',
    subtitle: 'In wenigen Schritten richtest du die App ein.',
    languageTitle: 'Sprache wählen',
    languageHint: 'Du kannst die Sprache später in den Einstellungen ändern.',
    languageEn: 'English',
    languageDe: 'Deutsch',
    appearanceTitle: 'Erscheinungsbild',
    appearanceHint: 'Helles oder dunkles Design – jederzeit in den Einstellungen änderbar.',
    pathTitle: 'Neu starten oder importieren?',
    pathHint: 'Wähle, ob du frisch beginnst oder ein Backup wiederherstellen möchtest.',
    newTitle: 'Neu hier',
    newDesc: 'Lege los und verbinde optional CalDAV und Apple Reminders.',
    importTitle: 'Daten importieren',
    importDesc: 'Stelle ein Backup wieder her – inkl. CalDAV- und Apple-Reminders-Konten.',
    importStepTitle: 'Backup importieren',
    importStepHint: 'Wähle eine zuvor exportierte JSON-Datei. Die App wird danach neu geladen.',
    caldavTitle: 'CalDAV verbinden (optional)',
    caldavHint:
      'Importiere Termine aus Google, iCloud-Kalender, Nextcloud u. a. Du kannst diesen Schritt überspringen und später in den Einstellungen nachholen.',
    appleTitle: 'Apple Reminders verbinden (optional)',
    appleHint:
      'Echte iCloud-Erinnerungen – getrennt von CalDAV. Apple-ID, Passwort und ggf. Zwei-Faktor-Code nötig. Überspringbar.',
    accountsLinked: '{{count}} Konto/Konten verbunden',
    skip: 'Überspringen',
    finish: 'Los geht\'s',
    errorPath: 'Bitte wähle eine Option.',
  },
